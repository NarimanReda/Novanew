...
public class ProfileRetweetsAdapter extends RecyclerView.Adapter<ProfileRetweetsAdapter.myViewHolder>{
    List<Tweets> Tweets;
    Context context;
    public ProfileRetweetsAdapter(Context context)
    ...
    /**
     * @return
     * This methods return the count of the given Retweets list
     */
    @Override
