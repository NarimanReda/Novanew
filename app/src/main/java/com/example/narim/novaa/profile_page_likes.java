 ...
 */
public class profile_page_likes extends android.support.v4.app.Fragment {

    RecyclerView TweetRecView;
    List<Tweets> tweets= new ArrayList<>();
    Context context;
    View view;
    public profile_page_likes() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_profile_page_likes, container, false);
        context=getActivity();
        TweetRecView=view.findViewById(R.id.RecyclerView_ProfileLikes);
